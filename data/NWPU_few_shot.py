# Few-shot dataloaders for NWPU remote sensing dataset.
...
class SimpleDataset:
    def __init__(self, transform, target_transform=identity):
        if not os.path.isdir(IMAGE_ROOT):
            raise FileNotFoundError(f"NWPU images not found at {IMAGE_ROOT}")
...
class SetDataset:
    def __init__(self, batch_size, transform):
        ...
        self.sub_dataloader = []
        # Avoid nested multiprocessing inside episode workers on Windows
